...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.accordeon = function () {
  let headActive = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'accordeon-head--active';
  let contentActive = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'accordeon-content--active';
...
Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])('.accordeon-head').accordeon();
...
/* harmony import */ var _components_accordeon__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/accordeon */ "./src/js/lib/components/accordeon.js");
...
// показать скрытые, скрыть показанные элементы - toggle
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.animateиOverTime = function (duration, callback, finall) {
  let timeStart;
...
// анимация fadeIn
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.fadeIn = function (duration, display, finall) {
  for (let i = 0; i < this.length; i++) {
...
// анимация fadeOut
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.fadeOut = function (duration, finall) {
  for (let i = 0; i < this.length; i++) {
